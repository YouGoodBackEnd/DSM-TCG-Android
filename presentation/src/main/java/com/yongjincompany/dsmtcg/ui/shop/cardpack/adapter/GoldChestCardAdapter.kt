...
class GoldChestCardAdapter(
    private val dataList: ArrayList<GoldChestOpenEntity.Card>,
) : RecyclerView.Adapter<GoldChestCardAdapter.ViewHolder>() {
    ...
    class ViewHolder private constructor(
        ...
        fun bind(item: GoldChestOpenEntity.Card) {
